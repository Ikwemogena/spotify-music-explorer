export default defineEventHandler(async () =>{
    ...
    const authorizationUrl = `https://accounts.spotify.com/authorize?client_id=${spotifyClientSecret}&redirect_uri=${encodeURIComponent(redirectUri)}&response_type=code&scope=${encodeURIComponent(scope)}`;
